  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 650px; margin: auto; background: #ffffff; border-radius: 20px; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.1);">
    ...
    <tr>
      <td style="padding: 40px 30px;">
        ...
        <p style="font-size: 18px; color: #8b7cf6; text-align: center; font-weight: 600; margin: 0 0 25px 0;">Order #${orderNumber}</p>
        
        <!-- Thank You Message -->
        <table width="100%" cellpadding="0" cellspacing="0" style="background: #f8f9fa; border-radius: 15px; margin: 25px 0; border-left: 5px solid #8b7cf6;">
          <tr>
            ...
            <td style="padding: 25px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td style="padding: 8px 0; color: #8b7cf6; text-align: right;">${customerEmail}</td>
                </tr>
              </table>
            </td>
          </tr>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background: #f8f9fa; border-radius: 15px; margin: 25px 0; border-left: 5px solid #8b7cf6;">
          <tr>
            <td style="padding: 25px;">
              <h3 style="font-size: 18px; color: #333; margin: 0 0 15px 0; border-bottom: 2px solid #ddd; padding-bottom: 8px;">💰 Billing Details</h3>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr style="border-top: 2px solid #8b7cf6;">
                  <td style="padding: 15px 0 8px 0; font-size: 18px; font-weight: bold;">Total Amount Paid:</td>
                  <td style="padding: 15px 0 8px 0; text-align: right; font-size: 18px; font-weight: bold; color: #8b7cf6;">₹${totalAmount}</td>
                </tr>
              </table>
            </td>
          </tr>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background: #f8f9fa; border-radius: 15px; margin: 25px 0; border-left: 5px solid #8b7cf6;">
          <tr>
            <td style="padding: 25px; text-align: center;">
              <h3 style="color: #333; font-size: 16px; margin: 0 0 10px 0;">🚚 Estimated Delivery</h3>
              <p style="color: #8b7cf6; font-size: 18px; font-weight: bold; margin: 0 0 5px 0;">${estimatedDelivery}</p>
              <p style="color: #666; font-size: 14px; margin: 0;">We'll send you tracking details once your order is shipped</p>
            </td>
          </tr>
        </table>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
          <tr>
            <td style="text-align: center;">
              <a href="#" style="display: inline-block; background: #8b7cf6; color: white; text-decoration: none; font-weight: 600; font-size: 14px; padding: 12px 25px; border-radius: 25px; margin: 0 10px;">Track Your Order 📦</a>
              <a href="#" style="display: inline-block; background: #667eea; color: white; text-decoration: none; font-weight: 600; font-size: 14px; padding: 12px 25px; border-radius: 25px; margin: 0 10px;">Download Invoice 📄</a>
            </td>
          </tr>
        </table>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background: #f8f9fa; border-radius: 15px; margin: 25px 0; border-left: 5px solid #8b7cf6;">
          <tr>
            <td style="padding: 20px; text-align: center;">
              ...
              <p style="margin: 0;">
                📧 <a href="mailto:support@bloom.com" style="color: #8b7cf6; text-decoration: none;">support@bloom.com</a> | 
                📞 <span style="color: #333;">1800-BLOOM-24</span> | 
                💬 <a href="#" style="color: #8b7cf6; text-decoration: none;">Live Chat</a>
              </p>
            </td>
          </tr>
        </table>
